...
[^8]: The p-value in a linear regression tests the null hypothesis that the coefficient has no effect (\$\\beta\$ = zero). A low p-value indicates evidence for rejecting the null hypothesis and a high p-value indicates otherwise.
...
We imagine that the spatial data layer is appropriate as an input for any analyses that depend on nationwide water service coverage boundaries.
