...
Now, we zoom into California, Nevada, and Oregon three states with high proportions of Tier 1, 2, and 3 spatial boundaries respectively. 

```{r tamm zoom ca nv or}
# read TAMM output
tamm <- here("tamm_layer/2022-03-26_tamm.rds") %>% read_rds()
