...
```{r}
# lm CI layers
t3m_med <- st_read(path(staging_path, "tier3_median.geojson"))
t3m_cil <- st_read(path(staging_path, "tier3_ci_upper_95.geojson"))
t3m_ciu <- st_read(path(staging_path, "tier3_ci_lower_05.geojson"))
